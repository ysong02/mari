...
typedef struct {
    ...
    // asn_dl recorded when join response is sent, used for attestation freshness
...
typedef struct {
    ...
    cell_t  cells[MARI_N_CELLS_MAX];  // cells in this schedule -- the first 3 must be beacons
} schedule_t;
